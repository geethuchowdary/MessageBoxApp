...
{
QMessageBox::information(this,"Geethika 212218104027","This Is Information Box");

}

void MainWindow::on_pushButton_2_clicked()
{
    QMessageBox::StandardButton reply= QMessageBox::question(this,"Geethika","Do You Like Apples",QMessageBox::Yes|QMessageBox::No);
...
{
    QMessageBox::StandardButton reply= QMessageBox::question(this,"Geethika","this is a custom message",QMessageBox::Yes|QMessageBox::No|QMessageBox::YesAll|QMessageBox::NoAll);
    if(reply==QMessageBox::Yes)
